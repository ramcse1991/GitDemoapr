...
//		 Tagname[attribute='value']
		...
		// driver.findElement(By.xpath("//input[@type='text'][2]")).sendKeys("john@rsa.com");
		 ...
		 driver.findElement(By.xpath("//form/input[3]")).sendKeys("9629035178");
		 driver.findElement(By.cssSelector(".reset-pwd-btn")).click();
		 System.out.println(driver.findElement(By.cssSelector("form p")).getText());
		// driver.findElement(By.xpath("//div[contains(@class,'btn')]")).click();
		 // xpath
		...
		// driver.findElement(By.className("submit signInBtn")).
